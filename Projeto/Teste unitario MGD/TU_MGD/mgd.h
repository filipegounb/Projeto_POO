...
public:
    ...
    * \param <disciplina_professor> - Disciplina ministrada pelo Professor (para desativar o filtro de busca com disciplina, deve-se entrar com o valor " " - espaco - nestes campo)
    * \param <*nome_arquivo> - Nome do arquivo que possui as notas (por padrao, tem o valor "dados/Notas.txt")
    *
    * \return - Retorna a quantidade de disciplinas que tem notas publicadas para esta matricula
    *
    */
    int obter_conjunto_notas (const string&, const string&, const char *nome_arquivo = "dados/Notas.txt");
